...
function createAccount(type: number): void {
    ...
    if (type) {
        ...
        let skill: string = (document.getElementById("pf_skills") as HTMLInputElement).value
        ...
        let skill: string = (document.getElementById("pj_skills") as HTMLInputElement).value
